...
export const metadata = {
  title: "Terms of Service | PurposeBid",
  description: "Terms of Service for PurposeBid, operated by For Purpose Life.",
};
  ...
  return (
    <div className="min-h-screen bg-[#faf8f4] text-[#1a1916]">
      ...
      <header className="border-b border-[#e5e0d5] bg-white px-6 py-4 flex items-center justify-between">
        <Link href="/" className="font-bold text-[#09a7ad] text-lg tracking-tight">PurposeBid</Link>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-[#4a4640] leading-relaxed">
          ...
          <section>
            ...
            <p>These Terms of Service ("Terms") govern your access to and use of PurposeBid ("Platform"), a service operated by For Purpose Life ("Company," "we," "us," or "our"). By accessing or using PurposeBid at purposebid.com, you agree to be bound by these Terms. If you do not agree, do not use the Platform.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#1a1916] mb-3">2. Who We Are</h2>
            <p>PurposeBid is an online auction platform that enables nonprofit organizations and charitable causes ("Organizations") to host fundraising auctions. Registered users ("Bidders") may participate in those auctions by placing bids on listed items.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">When you place a bid on PurposeBid, you are entering into a binding commitment to purchase the item at that price if you are the winning bidder. By placing a bid, you:</p>
          ...
          <section>
            ...
            <p className="mb-3">All payments are processed securely through Stripe. By saving a payment method, you authorize PurposeBid to charge your card in the event you win an auction. Charges occur automatically when an auction closes.</p>
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>PurposeBid is not responsible for items not delivered or disputes between Bidders and Organizations.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#1a1916] mb-3">7. Organizations</h2>
            <p className="mb-3">Organizations that host auctions on PurposeBid agree to:</p>
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>Connect a valid Stripe account to receive funds. PurposeBid processes payments on behalf of Organizations via Stripe Connect.</li>
            </ul>
