          ...
          <div className="flex-1 space-y-12">
            ...
            <Section id="how-bidding-works" title="How Bidding Works" icon={
              ...
              <div className="bg-white border border-[#e5e0d5] rounded-2xl p-6 space-y-4 text-sm text-[#4a4640] leading-relaxed">
                <p>
                  PurposeBid uses a <strong className="text-[#1a1916]">live online auction</strong> format. Items are listed with a starting bid, and the highest bid when time runs out wins.
                </p>
