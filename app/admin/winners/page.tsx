              ...
              <table className="w-full min-w-[600px]">
                <thead>
                  <tr className="border-b border-gray-800">
                    ...
                    <th className="text-left px-6 py-4 text-gray-500 text-sm font-medium">Item Status</th>
                    ...
                    return (
                      <tr key={bid.id} className="border-b border-gray-800 last:border-0 hover:bg-gray-800/50">
                        ...
                        <td className="px-6 py-4">
                          {payment?.status === "PAID" ? (
                            <span className="text-xs bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded-full">Paid</span>
                          ) : (
                            <span className="text-xs bg-yellow-500/20 text-yellow-400 px-2 py-1 rounded-full">Unpaid</span>
                          )}
                        </td>
                        <td className="px-6 py-4">
                          <span className={`text-xs px-2 py-1 rounded-full ${
                            bid.item.status === "SOLD" ? "bg-blue-500/20 text-blue-400"
                            : (bid.item.status as string) === "PENDING_PICKUP" ? "bg-yellow-500/20 text-yellow-400"
