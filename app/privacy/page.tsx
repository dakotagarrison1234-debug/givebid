...
export const metadata = {
  title: "Privacy Policy | PurposeBid",
  description: "Privacy Policy for PurposeBid, operated by For Purpose Life.",
};
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-[#4a4640] leading-relaxed">
          ...
          <section>
            ...
            <p>For Purpose Life ("we," "us," or "our") operates PurposeBid at purposebid.com. This Privacy Policy explains how we collect, use, share, and protect your personal information when you use our Platform. By using PurposeBid, you agree to the practices described in this policy.</p>
          </section>
          ...
          <section>
            ...
            <p>PurposeBid is not intended for children under the age of 18. We do not knowingly collect personal information from minors. If you believe a minor has provided us with personal information, please contact us and we will promptly delete it.</p>
          </section>
          ...
          <section>
            ...
            <div className="mt-3 bg-[#f0fafa] border border-[#09a7ad]/20 rounded-xl p-4">
              ...
              <p>Website: <a href="https://purposebid.com" className="text-[#09a7ad] hover:underline">purposebid.com</a></p>
            </div>
          </section>
